...
FAT12는 **12비트 주소를 사용하는 파일 시스템**으로, **간단하고 작은 디스크**에 적합한 파일 시스템이다.

---

### 2️⃣ FAT12의 특징

- **파일 크기 제한**: 4GB 이하의 파일만 지원
- **디스크 크기 제한**: 최대 32MB 크기의 디스크만 지원
- **단점**: 작은 디스크에서만 사용되며, **파일 할당 테이블 크기**가 커짐에 따라 효율성이 떨어진다.

---

### 3️⃣ FAT12와 다른 FAT 시스템의 차이

- **FAT12**: 12비트 주소 사용, **최대 4,096 클러스터**
- **FAT16**: 16비트 주소 사용, **최대 65,536 클러스터**
- **FAT32**: 32비트 주소 사용, **더 큰 디스크와 파일 크기 지원**
